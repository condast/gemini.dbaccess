...
public class Activator implements BundleActivator {
    ...
    private ServiceRegistration<Object> embeddedService, clientService, clientService4;
	ServiceRegistration<?> embeddedService4;	
	...
	public void start(BundleContext context) throws Exception {
        ...
        embeddedService = (ServiceRegistration<Object>) context.registerService( 
        ...
        clientService = (ServiceRegistration<Object>) context.registerService( 
                DataSourceFactory.class.getName(),
        ...
        props.put(DataSourceFactory.OSGI_JDBC_DRIVER_CLASS, 
                  DerbyServiceProperties.DERBY_CLIENT_DRIVER_CLASS);
        clientService4 = (ServiceRegistration<Object>) context.registerService( 
                DataSourceFactory.class.getName(),
